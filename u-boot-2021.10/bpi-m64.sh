...
BL31=`pwd`/../arm-trusted-firmware-sunxi-mainline/v2.2/build/sun50i_a64/debug/bl31.bin
export BL31
(cd `pwd`/../ ; ./build_atf_a64_v2.2.sh)

make $NEWBPICONF
make -j30
#make CROSS_COMPILE=aarch64-none-linux-gnu- $NEWBPICONF
#make -j8 CROSS_COMPILE=aarch64-none-linux-gnu- BL31=$BL31
